; ModuleID = '/mnt/nfs/clasnetappvm/homedirs/ywei51/DependentSystemDesign/llfi/TestGraphA-llfi_index.ll'
...
define i32 @main() #0 {
  ...
  %1 = alloca i32, align 4, !llfi_index !357
  %graphA = alloca %struct.Graph*, align 8, !llfi_index !358
  store i32 0, i32* %1, !llfi_index !359
  %2 = call %struct.Graph* @_Z14generateGraphAv(), !llfi_index !360
  store %struct.Graph* %2, %struct.Graph** %graphA, align 8, !llfi_index !361
  %3 = load %struct.Graph** %graphA, align 8, !llfi_index !362
  %fi = call %struct.Graph* @injectFault1(i64 361, %struct.Graph* %3, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  call void @_Z3bfsP5Graphi(%struct.Graph* %fi, i32 0), !llfi_index !363
  call void @postInjections()
  ret i32 0, !llfi_index !364
}

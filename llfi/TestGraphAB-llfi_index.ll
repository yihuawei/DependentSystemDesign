; ModuleID = '/mnt/nfs/clasnetappvm/homedirs/ywei51/DependentSystemDesign/TestGraphAB.ll'
...
define %struct.Graph* @_Z14generateGraphBv() #1 {
  %graph = alloca %struct.Graph*, align 8, !llfi_index !356
  %1 = call %struct.Graph* @_Z11createGraphi(i32 9), !llfi_index !357
  store %struct.Graph* %1, %struct.Graph** %graph, align 8, !llfi_index !358
  %2 = load %struct.Graph** %graph, align 8, !llfi_index !359
  call void @_Z7addEdgeP5Graphii(%struct.Graph* %2, i32 3, i32 7), !llfi_index !360
  %3 = load %struct.Graph** %graph, align 8, !llfi_index !361
  call void @_Z7addEdgeP5Graphii(%struct.Graph* %3, i32 3, i32 4), !llfi_index !362
  %4 = load %struct.Graph** %graph, align 8, !llfi_index !363
  call void @_Z7addEdgeP5Graphii(%struct.Graph* %4, i32 3, i32 5), !llfi_index !364
  %5 = load %struct.Graph** %graph, align 8, !llfi_index !365
  call void @_Z7addEdgeP5Graphii(%struct.Graph* %5, i32 4, i32 5), !llfi_index !366
  %6 = load %struct.Graph** %graph, align 8, !llfi_index !367
  call void @_Z7addEdgeP5Graphii(%struct.Graph* %6, i32 5, i32 6), !llfi_index !368
  %7 = load %struct.Graph** %graph, align 8, !llfi_index !369
  ret %struct.Graph* %7, !llfi_index !370
}

; Function Attrs: uwtable
define i32 @main() #0 {
  %1 = alloca i32, align 4, !llfi_index !371
  %graphA = alloca %struct.Graph*, align 8, !llfi_index !372
  %graphB = alloca %struct.Graph*, align 8, !llfi_index !373
  store i32 0, i32* %1, !llfi_index !374
  %2 = call %struct.Graph* @_Z14generateGraphAv(), !llfi_index !375
  store %struct.Graph* %2, %struct.Graph** %graphA, align 8, !llfi_index !376
  %3 = call %struct.Graph* @_Z14generateGraphBv(), !llfi_index !377
  store %struct.Graph* %3, %struct.Graph** %graphB, align 8, !llfi_index !378
  %4 = load %struct.Graph** %graphA, align 8, !llfi_index !379
  call void @_Z3bfsP5Graphi(%struct.Graph* %4, i32 0), !llfi_index !380
  %5 = load %struct.Graph** %graphB, align 8, !llfi_index !381
  call void @_Z3bfsP5Graphi(%struct.Graph* %5, i32 3), !llfi_index !382
  ret i32 0, !llfi_index !383
}
